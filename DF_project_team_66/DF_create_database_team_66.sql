...
ALTER TABLE groep_66.attractie ADD CONSTRAINT fk_attractie_haven FOREIGN KEY ( fk_haven_id ) REFERENCES groep_66.haven( haven_id );
...
ALTER TABLE groep_66.vaarroute_haven ADD CONSTRAINT fk_vaarroute_haven_vaarroute FOREIGN KEY ( fk_route_id ) REFERENCES groep_66.vaarroute( route_id );
ALTER TABLE groep_66.vaarroute_haven ADD CONSTRAINT fk_vaarroute_haven_haven FOREIGN KEY ( fk_haven_id ) REFERENCES groep_66.haven( haven_id );
...
ALTER TABLE groep_66.cruise ADD CONSTRAINT fk_cruise_schip FOREIGN KEY ( fk_schip_id ) REFERENCES groep_66.schip( schip_id );
ALTER TABLE groep_66.cruise ADD CONSTRAINT fk_cruise_vaarroute FOREIGN KEY ( fk_route_id ) REFERENCES groep_66.vaarroute( route_id );
...
ALTER TABLE groep_66.boeking ADD CONSTRAINT fk_boeking_cruise FOREIGN KEY ( fk_cruise_id ) REFERENCES groep_66.cruise( cruise_id );
ALTER TABLE groep_66.passagier ADD CONSTRAINT fk_passagier_boeking FOREIGN KEY ( fk_boeking_id ) REFERENCES groep_66.boeking( boeking_id );
...
ALTER TABLE groep_66.boeking_dienst ADD CONSTRAINT fk_boeking_dienst_dienst FOREIGN KEY ( fk_dienst_id ) REFERENCES groep_66.dienst( dienst_id );
ALTER TABLE groep_66.boeking_dienst ADD CONSTRAINT fk_boeking_dienst_boeking FOREIGN KEY ( fk_boeking_id ) REFERENCES groep_66.boeking( boeking_id );
...
ALTER TABLE groep_66.kamer ADD CONSTRAINT fk_kamer_schip FOREIGN KEY ( fk_schip_id ) REFERENCES groep_66.schip( schip_id );
ALTER TABLE groep_66.kamer ADD CONSTRAINT fk_kamer_boeking FOREIGN KEY ( fk_boeking_id ) REFERENCES groep_66.boeking( boeking_id );